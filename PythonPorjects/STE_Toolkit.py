...
class VBS4Panel(tk.Frame):
    ...
    def launch_fusers(self, ip_list):
        ...
        if _is_offline_enabled():
            default_path = resolve_network_working_folder_from_cfg(get_offline_cfg())
...
class SettingsPanel(tk.Frame):
    ...
    def _on_offline_toggle(self):
        ...
        try:
            ...
            pass
        messagebox.showinfo("Offline Mode", "Offline Mode is now " + ("ENABLED" if val else "DISABLED"))
        self._refresh_offline_resolved()
